...
Most extension developers ultimately choose Stripe for its flexibility, extensive documentation, and robust webhook system. The key implementation detail is using Stripe Checkout (hosted page) rather than embedded Elements, since the latter doesn't work reliably in extension contexts.
