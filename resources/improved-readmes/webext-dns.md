---
layout: default
title: "Chrome Extension DNS API: TypeScript Wrapper"
description: "Learn how to use the Chrome DNS API in extensions. TypeScript wrapper for DNS resolution in browser extensions."
---
